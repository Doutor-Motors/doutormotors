...
A rota `/estude-seu-carro` deveria ser **pública** (para atrair novos usuários com tutoriais gratuitos), mas estava protegida por login.

**Impacto:**
- ❌ Visitantes não conseguiam ver tutoriais
- ❌ Redução de conversão de visitantes em usuários
- ❌ Contradiz a proposta de valor do sistema
...
|---|----------|------------|---------|--------|
| 1 | Rota `/estude-seu-carro` pública | CRÍTICO | `App.tsx` | ✅ FEITO |
...
**Impacto:**
- ✅ Visitantes podem acessar tutoriais sem login
- ✅ Melhora conversão de visitantes em usuários
- ✅ Alinha com proposta de valor do sistema
...
**Por quê?** Garantir que monetização funciona  
...
- [ ] Testar Pix (geração + confirmação)
