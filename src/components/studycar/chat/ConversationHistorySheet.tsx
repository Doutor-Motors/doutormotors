                      ...
                      <CardContent className="p-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            <Button variant="ghost" size="icon" className="h-8 w-8" onClick={(e) => { e.stopPropagation(); onTogglePin(conv.id, conv.is_pinned || false); }}>{conv.is_pinned ? <PinOff className="w-4 h-4 text-primary" /> : <Pin className="w-4 h-4" />}</Button>
                            <Button variant="ghost" size="icon" className="h-8 w-8" onClick={(e) => handleStartEditing(conv, e)}><Edit2 className="w-4 h-4" /></Button>
                            <AlertDialog>
