...
const Header = () => {
  ...
  return (
    <header className={`absolute top-0 left-0 w-full z-50 px-4 md:px-10 py-4 ${isLandingPage ? "" : "bg-secondary"}`}>
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-12">
        <div className="flex flex-col lg:flex-row items-center gap-4">
          ...
          <div className="flex flex-col items-start cursor-default -mt-8">
