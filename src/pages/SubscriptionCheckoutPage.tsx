...
export default function SubscriptionCheckoutPage() {
  ...
  // PRODUÇÃO: Simulação de pagamento removida - usar apenas pagamentos reais via AbacatePay
        ...
        <div className={`w-full max-w-lg ${step !== "success" ? "pt-16" : ""}`}>
          ...
          {step !== "success" && (
            <motion.div
              ...
              className="mb-4"
            >
              <div className={`flex items-center justify-between px-4 py-3 rounded-xl border backdrop-blur-sm ${selectedPlan === "pro"
                  ? "bg-gradient-to-r from-amber-500/10 to-orange-500/10 border-amber-500/30"
                  : "bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border-blue-500/30"
                }`}>
                <div className="flex items-center gap-3">
                  <div className={`p-2 rounded-lg ${selectedPlan === "pro" ? "bg-amber-500/20" : "bg-blue-500/20"
                    }`}>
                    <Crown className={`w-5 h-5 ${selectedPlan === "pro" ? "text-amber-400" : "text-blue-400"
                      }`} />
                  </div>
                  <div>
                ...
                <div className="text-right">
                  <p className={`text-lg font-bold ${selectedPlan === "pro" ? "text-amber-400" : "text-blue-400"
                    }`}>
                    {formattedPrice}
                  </p>
                </div>
          ...
          >
            <Card className="bg-card/95 backdrop-blur-lg border-border/50 shadow-2xl overflow-hidden">
              ...
              <CardHeader className="text-center pb-4 bg-gradient-to-br from-primary/10 via-transparent to-transparent">
                ...
                >
                  <Badge className={`w-fit mx-auto mb-3 border-0 px-4 py-1.5 text-sm ${selectedPlan === "pro"
                ...
                <AnimatePresence mode="wait">
                  ...
                  {step === "form" && (
                    ...
                    >
                      ...
                      <div className={`relative overflow-hidden rounded-xl p-5 border ${selectedPlan === "pro"
                        ...
                        <div className={`absolute top-0 right-0 w-24 h-24 rounded-full blur-2xl ${selectedPlan === "pro" ? "bg-primary/10" : "bg-blue-500/10"
                          }`} />
                        ...
                        <div className="relative">
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className={`text-3xl font-bold font-chakra ${selectedPlan === "pro" ? "text-primary" : "text-blue-400"
                                }`}>
                                {formattedPrice}
                              </p>
                            ...
                            <div className={`p-3 rounded-full ${selectedPlan === "pro" ? "bg-primary/20" : "bg-blue-500/20"
                              }`}>
                              <Crown className={`w-8 h-8 ${selectedPlan === "pro" ? "text-primary" : "text-blue-400"
                                }`} />
                            </div>
                          </div>
                          ...
                          <div className="space-y-2">
                            <p className={`text-xs font-semibold uppercase tracking-wide ${selectedPlan === "pro" ? "text-primary" : "text-blue-400"
                              }`}>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              {(selectedPlan === "pro" ? PRO_BENEFITS : BASIC_BENEFITS).map((benefit, i) => (
                                <div key={i} className="flex items-center gap-2 text-sm">
                                  <benefit.icon className={`w-4 h-4 shrink-0 ${selectedPlan === "pro" ? "text-primary" : "text-blue-400"
                                    }`} />
                    ...
                    >
                      ...
                      <div className="bg-gradient-to-br from-muted/50 to-muted/20 rounded-xl p-5 border border-border/30">
                        ...
                        {pixData.devMode !== undefined && (
                          <div className={`mb-3 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${pixData.devMode
                      ...
                      {webhookStatus !== "idle" && (
                        <motion.div
                          initial={{ opacity: 0, y: 10 }}
                          animate={{ opacity: 1, y: 0 }}
                          className={`flex items-center justify-center gap-3 p-3 rounded-lg border ${webhookStatus === "waiting"
                  ...
                  {step === "success" && (
                    ...
                    >
                      ...
                      <div className={`p-4 rounded-xl border ${selectedPlan === "pro"
